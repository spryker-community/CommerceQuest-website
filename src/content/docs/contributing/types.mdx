...
<CardGrid stagger>
  ...
  <Card title="Spryker" icon="rocket">
...
\
   ...
   <Card title="Propel" icon="seti:database">
...
<CardGrid>
  ...
  <Card title="B2B Demo Marketplace" icon="rocket">
    The full Spryker demo shop — report bugs, submit PRs, or explore the codebase.\
    [Go to Demo Marketplace](https://github.com/spryker-shop/b2b-demo-marketplace)
  </Card>

  <Card title="Spryker Core Modules" icon="setting">
    Individual core modules — find the specific module you want to contribute to.\
    [Browse Core Modules](https://github.com/spryker)
  </Card>

  <Card title="Report a Bug" icon="warning">
    Found something broken? Open an issue with steps to reproduce and help us fix it.\
    [Open an Issue](https://github.com/spryker-shop/b2b-demo-marketplace/issues)
  </Card>

  <Card title="Submit a Pull Request" icon="add-document">
    Fix bugs, add features, or improve code. PRs get fast reviews from the Spryker core team.\
    [View Pull Requests](https://github.com/spryker-shop/b2b-demo-marketplace/pulls)
  </Card>

  <Card title="Community Extensions" icon="puzzle">
    Build and share your own Spryker modules as MIT-licensed packages for the ecosystem.\
    [Browse Extensions](https://github.com/spryker-community)
  </Card>
