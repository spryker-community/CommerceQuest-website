...
- Go to [the docs](https://commercequest.space/guides/intro/) (you're already there 😊) and browse to the article you want to adjust (just like the page your are reading right now);
...
### Validate if your change actually worked:
 ...
 - While the website is rebuilding, the status will be orange. Once it's green, you can check the changes on the [live site](https://commercequest.space/).
...
├── content/              # Markdown files for blog posts, products, and site configuration
│   ├── blog/
│   ├── docs/           
...
└── content.config.ts         # Contains site-wide configuration options
```
