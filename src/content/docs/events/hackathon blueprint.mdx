...
As an example: for previous hackathons we created a thread for each team on the CommerceQuest Hackathon subforum. Happy to do that for your hackathon as well!
